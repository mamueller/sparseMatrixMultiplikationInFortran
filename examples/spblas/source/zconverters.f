...
!   Content : Intel(R) MKL Sparse format converters FORTRAN example
!
!*******************************************************************************
!
...
c*******************************************************************************
     ...
     &            ldAbsr=4, nn=2, mn=16, idiag=3, ndiag=4)
      double complex ADNS(m,n),   ADNS_standard(m,n)
      double complex Absr(nzmax), Absr_standard(nzmax)
      double complex Acsc(nzmax), Acsc_standard(nzmax)
      double complex Acsr(nzmax), Acsr_standard(nzmax)
      double complex Acoo(nzmax), Acoo_standard(nzmax)
      double complex Adia(idiag*ndiag), Adia_standard(idiag*ndiag)
      double complex Asky(6)
      double complex Askyl_standard(6)
      ...
      data Absr_standard / (5.d0, 1.d0), (9.d0, 1.d0),
     &                     (8.d0, 1.d0),(2.d0,1.d0), 
     &                     (3.d0, 1.d0), (1.d0, 1.d0),
     &                     (6.d0,1.d0),(4.d0,1.d0) /
      data Acsc_standard / (5.d0, 1.d0), (9.d0, 1.d0),
     &                     (8.d0,1.d0), (2.d0,1.d0), 
     &                     (3.d0, 1.d0), (1.d0, 1.d0),
     &                     (6.d0,1.d0),(4.d0,1.d0) /
      data Acsr_standard / (5.d0,1.d0), (8.d0, 1.d0),
     &                     (9.d0, 1.d0),(2.d0,1.d0), 
     &                     (3.d0, 1.d0), (6.d0, 1.d0),
     &                     (1.d0, 1.d0),(4.d0,1.d0)/
      data Acoo_standard / (5.d0, 1.d0), (8.d0, 1.d0),
     &                     (9.d0, 1.d0),(2.d0,1.d0), 
     &                     (3.d0, 1.d0), (6.d0, 1.d0),
     &                     (1.d0, 1.d0),(4.d0,1.d0)/
      data Adia_standard / (0.d0, 0.d0), (9.d0, 1.d0),
     &                     (0.d0, 0.d0),(1.d0,1.d0),
     &                     (5.d0, 1.d0), (2.d0, 1.d0),
     &                     (3.d0, 1.d0),(4.d0,1.d0),
     &                     (8.d0, 1.d0), (0.d0, 0.d0),
     &                     (6.d0, 1.d0),(0.d0,0.d0)/
      data Askyl_standard /(5.d0, 1.d0), (9.d0, 1.d0),
     &                     (2.d0, 1.d0),(3.d0,1.d0), 
     &               (1.d0, 1.d0), (4.d0,1.d0)/
...
c***************************************************************************************************
      do j=1,n
        do i=1,m
           ADNS(i,j)=dcmplx(0.d0, 0.d0)
        enddo
      enddo
      ADNS(1,1)=dcmplx(5.d0, 1.d0)
      ADNS(1,2)=dcmplx(8.d0, 1.d0)
      ADNS(2,1)=dcmplx(9.d0, 1.d0)
      ADNS(2,2)=dcmplx(2.d0, 1.d0)
      ADNS(3,3)=dcmplx(3.d0, 1.d0)
      ADNS(3,4)=dcmplx(6.d0, 1.d0)
      ADNS(4,3)=dcmplx(1.d0, 1.d0)
      ADNS(4,4)=dcmplx(4.d0, 1.d0)
      do j=1,n
        do i=1,m
      ...
      job(1)=0
      job(6)=1
      call mkl_zdnscsr(job,m,n,Adns,lda,Acsr,AJ,AI,info)
...
c***************************************************************************************************
      ...
      call mkl_zcsrbsr (job,m,mblk,ldAbsr,Acsr,AJ,AI,Absr,AJB,AIB,info)
...
c***************************************************************************************************
      job(1) = 1
      job(6) = 3
      call mkl_zcsrbsr (job,nn,mblk,ldAbsr,Acsr,AJ,AI,Absr,AJB,AIB,info)
...
c***************************************************************************************************
      ...
      id = idiag
      nd = ndiag
      call mkl_zcsrdia(job,n,Acsr,AJ,AI,Adia,nd,distance,id,Acsr,
     &                 AJ,AI,info)
...
c***************************************************************************************************
      job(1) = 0
      job(6) = 1
      call mkl_zcsrcsc(job,n,Acsr,AJ,AI,Acsc,AJ1,AI1,info)
...
c***************************************************************************************************
      ...
      job(5) = 6
      job(6) = 0
      call mkl_zcsrsky(job,n,Acsr,AJ,AI,Asky,pointers,info)
