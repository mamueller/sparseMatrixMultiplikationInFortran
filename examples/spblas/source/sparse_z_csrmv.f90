...
!
!       The code computes A*S = F using MKL_SPARSE_Z_MV 
...
!   *****************************************************************************
    ...
    print*,'EXAMPLE PROGRAM FOR MKL_SPARSE_Z_MV'
    print*,'---------------------------------------------------'
    print*,''
    print*,'INPUT DATA FOR MKL_SPARSE_Z_MV'
...
!   Create CSR matrix
    i = MKL_SPARSE_Z_CREATE_CSR(csrA,SPARSE_INDEX_BASE_ZERO,M,N,csrRowPtr,csrRowPtr(2),csrColInd,csrVal)
...
!   Compute y = alpha * A * x + beta * y
    info = MKL_SPARSE_Z_MV(SPARSE_OPERATION_NON_TRANSPOSE,alpha,csrA,descrA,x,beta,y)
