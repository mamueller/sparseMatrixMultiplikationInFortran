...
c*******************************************************************************
     ...
     &            ldAbsr=4, nn=2, mn=16, idiag=3, ndiag=4)
      double precision ADNS(m,n),   ADNS_standard(m,n)
      double precision Absr(nzmax), Absr_standard(nzmax)
      double precision Acsc(nzmax), Acsc_standard(nzmax)
      double precision Acsr(nzmax), Acsr_standard(nzmax)
      double precision Acoo(nzmax), Acoo_standard(nzmax)
      double precision Adia(idiag*ndiag), Adia_standard(idiag*ndiag)
      double precision Asky(6)
      double precision Askyl_standard(6)
...
c***************************************************************************************************
      ...
      id = idiag
      nd = ndiag
      call mkl_dcsrdia(job,n,Acsr,AJ,AI,Adia,nd,distance,id,Acsr,
     &                 AJ,AI,info)
