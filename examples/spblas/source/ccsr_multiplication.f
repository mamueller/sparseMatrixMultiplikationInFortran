...
C..  Description of all variables
      CHARACTER trans
      INTEGER n, sort, job, ierr, nzmax, sizeint
      INTEGER ia(9)
      INTEGER ja(20)
...
c ..
     ...
     8                     3,                       7,    8/
      DATA a
     1     /(7.0, 1.d0), (1.0,1.0), (2.0,1.0), (7.0,1.0),
...
c ..
c ..   Compute the result matrix with the help of mkl_ccsrmultd
c ..
      call mkl_ccsrmultd(trans, n, n, n, a,ja,ia,
     *          a, ja, ia, answer, n)
c ..  
...
c ..  
      ...
      job=0
      call mkl_ccsrmultcsr(trans, job, sort, n, n, n, a,ja,ia,
...
c ..
      ...
      job=1
      call mkl_ccsrmultcsr(trans, job, sort, n, n, n, a,ja,ia,
     *        a, ja,ia, cdum, idum, ic, idum, idum)
      nnz=ic(n+1)-1
