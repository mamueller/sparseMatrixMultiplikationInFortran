...
!          MKL_SSKYSM  MKL_SSKYSV  MKL_SSKYMM  MKL_SSKYMV.
!
...
!
!       1. The code computes (L+D)*S = F using MKL_SSKYMM where S is a known 5 by 2
!          matrix and then the code solves the system A*X = F with the help of MKL_SSKYSM.
!          It's evident that X should be equal to S.
!
!       2. The code computes (U+I)*S = F using MKL_SSKYMV where S is a vector
!          and then the code solves the system A*X = F with the single right hand side.
!          It's evident that X should be equal to S.
!
!       3. The code computes D*S = F using MKL_SSKYMV where S is a vector
!          and then the code solves the system D*X = F with the single right hand side.
!          It's evident that X should be equal to S.
!
!       4. The next step is the computation (L+D+L') S = F using MKL_SSKYMV where S is
!          a vector. It is easy to see that L+D+L' is a symmetric matrix.
!
!       5. The next step is the computation (U-U') S = F using MKL_SSKYMV where S is
...
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SSKYMM '
          ...
          print 104, ((sol(i,j),j=1,n),i=1,m)
           ...
           call mkl_sskymm('n', m, n, m, alpha, 'tln',
     &           val_lower, pointers_lower, sol, m,  beta, rhs,  m)
          print*
          print*, '     OUTPUT DATA FOR MKL_SSKYMM '
          print*, '     WITH TRIANGULAR MATRIX  '
          ...
          print*, ' right hand side  '
           ...
           call mkl_sskysm('n', m, n, alpha, 'tln',
     &           val_lower, pointers_lower, rhs, m, temp,  m)

          print*
          print*, '     OUTPUT DATA FOR MKL_SSKYSM '
...
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SSKYMV '
          print*, '     WITH TRIANGULAR MATRIX  '
          print 102, alpha, beta
          print 103, 'n'
          print*, ' Input vector '
          print 105, (sol(i,1),i=1,m)
           ...
           call mkl_sskymv('n', m, m, alpha, 'tuu',
     &           val_upper, pointers_upper, sol, beta, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SSKYMV '
          print*, '     WITH TRIANGULAR MATRIX  '
          ...
          call mkl_sskysv('n', m,  alpha, 'tuu',
     &           val_upper, pointers_upper, rhs, temp)

          print*
          print*, '     OUTPUT DATA FOR MKL_SSKYSV '
          print*, '     WITH TRIANGULAR MATRIX  '
...
!*******************************************************************************
          ...
          print 105, (sol(i,2),i=1,m)
           ...
           call mkl_sskymv('t', m, m, alpha, 'dun',
     &           val_upper, pointers_upper, sol(1,2), beta, rhs)
          ...
          print*, ' with the help of MKL_SSKYSV '


          call mkl_sskysv('c', m,  alpha, 'dun',
     &           val_upper, pointers_upper, rhs, temp)
...
!*******************************************************************************
          ...
          print 105, (sol(i, 1),i=1,m)
           ...
           call mkl_sskymv('t', m, m, alpha, 'slu',
...
!*******************************************************************************
          ...
          print 105, (sol(i, 1),i=1,m)
           ...
           call mkl_sskymv('n', m, m, alpha, 'au',
     &           val_upper, pointers_upper, sol, beta, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SSKYMV '
          print*, '     WITH SKEW-SYMMETRIC MATRIX  '
