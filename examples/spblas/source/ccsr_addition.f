...
********************************************************************************
C----------------------------------------------------------------------
C Example program to show the use of the Intel(R) MKL Sparse BLAS routine
...
C..  Description of all variables
      ...
      INTEGER ia(9)
      INTEGER ja(20)
      COMPLEX a(20), cden(8, 8), answer(8, 8) 
      COMPLEX beta, cdum, zero
      REAL    tolerance, normA, normres
...
c ..
      ...
      DATA beta/(1.0, 0.0)/, zero/(0.0, 0.0)/
     ...
     8                     3,                       7,    8/
      ...
      DATA a
     1     /(7.0, 1.0), (1.0,1.0), (2.0,1.0), (7.0,1.0),
     2      (-4.0,0.0), (8.0,1.0), (2.0,1.0),                   
     3      (1.0,1.0),  (5.0,1.0),            
     4      (7.0,0.0),  (9.0,1.0),     
     5      (-4.0,1.0),       
     6      (7.0,1.0),  (3.0,1.0), (8.0,0.0),         
     7      (1.0,1.0),  (11.0,1.0),      
     8      (-3.0,1.0), (2.0,1.0), (5.0,0.0)/ 
C..
...
c ..
	...
	do j=ia(i), ia(i+1)-1
	  ...
	  answer(i, js)=answer(i, js)+ a(j)
        ...
        enddo
      enddo
      normA=scnrm2(ia(n+1)-1, a, 1)
      tolerance=2.0*sqrt(dble(n))*tolerance*normA 
c ..
...
c ..
      ...
      job=1 
      call mkl_ccsradd(trans, job, sort, n, n, a,ja,ia,
     *         beta, a, ja,ia, cdum, idum, ic, idum, idum) 
      nnz=ic(n+1)-1
