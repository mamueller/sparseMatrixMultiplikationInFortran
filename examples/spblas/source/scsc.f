...
!*******************************************************************************
     ...
     &    5.D0, 4.D0, 3.D0, 2.D0, 1.D0/
          ...
          integer i, j
          print*
          print*, ' EXAMPLE PROGRAM FOR COMPRESSED SPARSE ROW FORMAT ROU
     &      TINES '
...
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SCSCMM '
          ...
          print 104, ((sol(i,j),j=1,n),i=1,m)
           ...
           call mkl_scscmm('t', m, n, m, alpha, 'tln',
     &       values, rows, colIndex, colIndex(2), sol, m,
     &         beta, rhs,  m)
          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCMM '
          print*, '     WITH TRIANGULAR MATRIX  '
          print 104, ((rhs(i,j),j=1,n),i=1,m)
          print 100
          print*, ' Solve triangular system with obtained '
          print*, ' right hand side  '
          call mkl_scscsm('t', m, n, alpha, 'tln',
     &           values,  rows, colIndex, colIndex(2), rhs, m, temp,  m)

          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCSM '
...
!*******************************************************************************
          ...
          enddo
          print*
          print*, '     INPUT DATA FOR MKL_SCSCMV '
          print*, '     WITH TRIANGULAR MATRIX  '
          print 102, alpha, beta
          print 103, 't'
          print*, ' Input vector '
          print 105, (sol(i,1),i=1,m)
           ...
           call mkl_scscmv('t', m, m, alpha, 'tuu',
     &           values, rows, pointerB, pointerE, sol, beta, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCMV '
          print*, '     WITH TRIANGULAR MATRIX  '
          print 105, (rhs(i,1),i=1,m)
          print 100
          print*, ' Solve triangular system with obtained '
          print*, ' right hand side  '
          call mkl_scscsv('t', m, alpha, 'tuu',
     &         values, rows, colIndex, colIndex(2),  rhs, temp)
          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCTRSV '
          print*, '     WITH TRIANGULAR MATRIX  '
...
!*******************************************************************************
          ...
          print 105, (sol(i,2),i=1,m)
           ...
           call mkl_scscmv('n', m, m, alpha, 'dun',
     &          values, rows, pointerB, pointerE,  sol(1,2), beta, rhs)
          ...
          print*, ' with the help of MKL_SCSCSV '


          call mkl_scscsv('t', m, alpha, 'dun',
     &         values, rows, colIndex, colIndex(2),  rhs, temp)

          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCSV '
          print*, '     WITH DIAGONAL MATRIX  '
          print 105, (temp(i,1),i=1,m)
          print 100
...
!*******************************************************************************
          ...
          print 105, (sol(i, 1),i=1,m)
           ...
           call mkl_scscmv('n', m, m, alpha, 'au',
...
!*******************************************************************************
          ...
          call mkl_scscmv('n', m, m, alpha, 'sln',
     &          values, rows, colIndex, colIndex(2), sol, beta, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCMV '
          print*, '     WITH SYMMETRIC MATRIX  '
          ...
          print 100
!*******************************************************************************
! Task 6.   Obtain matrix-vector multiply A'*sol --> rhs whith the help of MKL_SCSCMV
!
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SCSCMV '
...
!*******************************************************************************
! Task 7.  Obtain matrix-vector multiply T*sol --> rhs whith the help of MKL_SCSCMV
...
!*******************************************************************************
          ...
          print 105, (sol(i, 1),i=1,mnew)
           call mkl_scscmv('n', mnew, mnew, alpha, 'tln', values,
     &       rows,   pointerB, pointerE,  sol, beta, rhs)

          print*
          print*, '     OUTPUT DATA FOR MKL_SCSCGEMV '
          print*, '     WITH A MINOR OF GENERAL MATRIX  '
          ...
          call mkl_scscsv('n', mnew, alpha, 'tln', values,
