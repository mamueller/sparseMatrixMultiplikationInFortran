...
!
!       2. The code computes (U+I)'*S = F using MKL_SBSRMV where S is a vector
...
!*******************************************************************************
          integer n
          parameter (n = 2)
          real*4 rhs(m*lb, n), sol(m*lb, n), temp(m*lb, n)
          data sol/1.0, 1.0, 1.0, 1.0,
     &             4.0, 3.0, 2.0, 1.0/
          real*4 alpha, beta
...
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SBSRMM '
...
!*******************************************************************************
          ...
          enddo
          print*
          print*, '     INPUT DATA FOR MKL_SBSRMV '
          print*, '     WITH TRIANGULAR MATRIX    '
          print 102, alpha, beta
          print 103, 't'
          print*, ' Input vector '
          print 105, (sol(i,1),i=1,m*lb)
           ...
           call mkl_sbsrmv('t', m, m, lb, alpha, 'tunf',
     &           values, columns, pointerB, pointerE, sol, beta, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SBSRMV '
          print*, '     WITH TRIANGULAR MATRIX     '
          print 105, (rhs(i,1),i=1,m*lb)
          print 100
          print*, ' Solve triangular system with obtained '
          print*, ' right hand side  '
          call mkl_sbsrtrsv('u', 't', 'n', m, lb,
     &           values, rowIndex, columns, rhs, temp)
          print*
          print*, '     OUTPUT DATA FOR MKL_SBSRTRSV '
          print*, '     WITH TRIANGULAR MATRIX  '
...
!*******************************************************************************
          ...
          print 105, (sol(i, 1),i=1,m*lb)
           ...
           call mkl_sbsrmv('n', m, m, lb, alpha, 'au f',
...
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SBSRSYMV '
          print*, '     WITH SYMMETRIC MATRIX       '
          print 102, alpha, beta
          print*, ' Input vector '
          print 105, (sol(i, 1),i=1,m*lb)

           call mkl_sbsrsymv('l', m, lb, values, rowIndex, columns,
     &           sol, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SBSRSYMV '
          print*, '     WITH SYMMETRIC MATRIX        '
          print 105, (rhs(i,1),i=1,m*lb)
          print 100
!*******************************************************************************
! Task 5.   Obtain matrix-vector multiply A'*sol --> rhs whith the help of MKL_SBSRGEMV
!
!*******************************************************************************
          print*
          print*, '     INPUT DATA FOR MKL_SBSRGEMV '
          ...
          print 105, (sol(i, 1),i=1,m*lb)
           ...
           call mkl_sbsrgemv('t', m, lb, values, rowIndex, columns,
     &           sol, rhs)
          print*
          print*, '     OUTPUT DATA FOR MKL_SBSRGEMV '
          print*, '     WITH GENERAL MATRIX          '
          print 105, (rhs(i,1),i=1,m*lb)
          print 100
